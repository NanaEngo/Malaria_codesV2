...
All code, frozen splits (random and scaffold, five seeds each), per-fold results, salience data, figure scripts, and the canonical \num{19836}-molecule panel are deposited on Zenodo (\url{https://doi.org/10.5281/zenodo.19608875}) and available under the MIT licence in the GitHub repository (\url{https://github.com/NanaEngo/Malaria_codesV2}). Trained checkpoints are included. Reproducibility is supported by the frozen split files, the frozen feature tables, and the pinned environment.
