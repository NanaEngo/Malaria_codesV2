...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.98\textwidth]{p4_evidence_overview.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.86\textwidth]{rrs_pns_profile.pdf}
