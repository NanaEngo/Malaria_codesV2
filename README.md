...
| **4** | `Project4_Advanced_Monte_CarloV2607/` | Pareto MCTS for de novo antimalarial design | 🔄 Manuscript in preparation — v11 20-seed benchmark complete (optimal MCTS config, re-run 02/08, reproducible) |
