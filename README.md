...
|---|-----------|-------|--------|
| **1** | `Project1_Chem_space_antimalarial_V2607_CorrectedGrid/` | AI discovery of antimalarials from African chemical space | ✅ Submission-ready (JCIM) |
...
Malaria_codesV2/
├── README.md
├── Project1_Chem_space_antimalarial_V2607_CorrectedGrid/     → 12 scripts, LaTeX, bibliography, results
...
## Related Data (in Malaria_codes repository)

| Data | Location | Size | Description |
|------|----------|------|-------------|
| Docking results | `Malaria_codes/Docking/` | 48k files | Vina + DiffDock outputs for 4 targets |
| Input data | `Malaria_codes/data/` | 119 MB | Proteins, ligands, databases |
| Analysis | `Malaria_codes/results/` | 17 MB | Enrichment, figures, tables |
...
- **P1:** `/home/nanaengo/Project1_Chem_space_antimalarial_V2_CorrectedGrid/results/`
