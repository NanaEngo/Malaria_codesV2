#!/usr/bin/env python3
"""Generate the P1 V7 chemical-space coverage figure.
...
OUT = V7 / "results" / "figures"
GRAPHICS = V7 / "manuscript" / "Graphics"
...
def main() -> None:
    ...
    outputs = []
    for ext in ("pdf", "png"):
        p = OUT / f"p1_v7_chemical_space_coverage.{ext}"
    ...
    provenance = {
        "schema": "p1-v7-chemical-space-coverage/v1",
    ...
    prov = OUT / "p1_v7_chemical_space_coverage_provenance.json"
