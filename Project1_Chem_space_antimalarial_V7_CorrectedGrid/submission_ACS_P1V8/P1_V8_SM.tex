...
The integrated candidate manifest, raw docking table, RRS table, cross-metric matrix, scripts, receptor files, ligand files, and provenance records are archived on Zenodo under an MIT license; the archival DOI will be provided upon assignment and added to this section. The figures and derived tables are reproducible computational outputs; they do not substitute for independent structural or experimental validation.
