...
The integrated candidate manifest, raw docking table, RRS table, cross-metric matrix, scripts, receptor files, ligand files, and provenance records are available at \url{https://github.com/NanaEngo/Malaria_codesV2} (MIT license, archival release \texttt{v1.0.0}). A permanent archival DOI on Zenodo is being minted for this release and will be added to this section upon assignment. The figures and derived tables are reproducible computational outputs; they do not substitute for independent structural or experimental validation.
