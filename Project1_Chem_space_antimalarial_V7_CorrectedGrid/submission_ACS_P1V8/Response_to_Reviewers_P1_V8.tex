...
will be published on Zenodo under an MIT license, with a versioned release record and the
...
sha256-verified manifest, MIT license) has been assembled for Zenodo publication; the archival
