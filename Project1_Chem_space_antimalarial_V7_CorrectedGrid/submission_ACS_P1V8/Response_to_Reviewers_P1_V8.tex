...
The neutral-within-null reading is consistent with unpublished companion-layer sensitivity checks in the P2 layer. (i) An external docking replication (39 ligands
...
(\qty{<0.06}{\kilo\calorie\per\mole}) was measured under the P2 canonical-grid protocol and therefore
