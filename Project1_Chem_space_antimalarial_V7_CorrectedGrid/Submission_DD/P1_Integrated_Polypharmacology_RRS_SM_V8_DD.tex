...
\usepackage{xr}
\externaldocument[M-]{P1_Integrated_Polypharmacology_RRS_Main_V8_DD}
...
\begin{document}
	...
	\begin{table}[ht!]
		...
		\begin{tabular}{@{}l>{\raggedright\arraybackslash}p{0.69\linewidth}r@{}}
			...
			\midrule
			A* & maximum absolute eligible WT score $\geq\qty{7}{\kilo\calorie\per\mol}$ and all available RRS values $\geq\qty{80}{\percent}$ & 7 \\
	...
	The candidate manifest, docking and RRS tables, cross-metric matrix, scripts, receptor/ligand files, and run records are archived on Zenodo under an MIT license at \url{https://doi.org/10.5281/zenodo.22696778}. The figures and derived tables are reproducible computational outputs; they do not substitute for independent structural or experimental validation.
