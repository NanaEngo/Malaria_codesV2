...
- Le fichier main doit s'appeler `manuscript.pdf` ou `P1_V7_main.pdf` (accepté)
- Supporting Information = **`Supporting_Information.pdf`** (exactement ce nom — convention ACS)
- Cover Letter = `Cover_Letter_P1_V7.pdf` (accepté)
- TOC Graphic = `p1_v7_toc_graphic_ACS.tiff` (accepté tout nom décrivant le contenu)
...
|---------|----------------------|
| `P1_V7_main.tex` | `submission_ACS_P1V7/P1_V7_main.tex` |
| `P1_V7_main.bbl` | `submission_ACS_P1V7/P1_V7_main.bbl` |
| `P1_V7_main.aux` | `submission_ACS_P1V7/P1_V7_main.aux` |
| `P1_V7_SM.tex` | `submission_ACS_P1V7/P1_V7_SM.tex` |
| `P1_V7_SM.bbl` | `submission_ACS_P1V7/P1_V7_SM.bbl` |
| `P1_V7_SM.aux` | `submission_ACS_P1V7/P1_V7_SM.aux` |
| `Sao_Chim_Space.bib` | `submission_ACS_P1V7/Sao_Chim_Space.bib` |
| `Sao_Chim_Space.bib` | `submission_ACS_P1V7/Sao_Chim_Space.bib` (bibliographie commune main/SM) |
| `Cover_Letter_P1_V7.tex` | `submission_ACS_P1V7/Cover_Letter_P1_V7.tex` |
| Figures ×3 | `submission_ACS_P1V7/Figure_*.pdf` |
| TOC graphic PDF | `submission_ACS_P1V7/p1_v7_toc_graphic.pdf` |
| TOC graphic TIFF | `submission_ACS_P1V7/p1_v7_toc_graphic_ACS.tiff` |

→ Compresser l'ensemble dans une archive zip `P1_V7_source.zip` avant l'upload.
...
| *(après acceptation)* `P1_V7_source.zip` | ~Variable | Sources LaTeX complètes |
...
| Tableaux larges dépassent des marges | Les tableaux `tabularx` de P1 V7 passent — vérifier dans l'aperçu |
