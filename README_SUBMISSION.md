...
| **P5** | Journal of Cheminformatics | Leak-audited benchmark and public validation complete; final deposit/author checks remain | `Project5_GNN_Transformer_DrugDiscovery/manuscript/SUBMISSION_MANIFEST.md` |

## Rules

- The manifest in each project is authoritative for its file list, hashes, and page counts.
...
The GitHub repository is currently reviewer-accessible. Zenodo DOI `10.5281/zenodo.19608875` is reserved; upload remains pending and must not be described as complete.
