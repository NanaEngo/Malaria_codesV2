...
**Generated:** July 9, 2026 — **Updated July 29, 2026** (v35: P4 v9 20-seed benchmark data consolidated and cross-verified against raw CSVs; component/fragment ablation and Pareto-front provenance documented; P3 classical-only 19,849 benchmark corrected (ECFP4 0.949; PHCO 0.897); full hybrid benchmark launched on HPC (job 12617, depends on smoke job 12616); expanded H₁-RRS n=77 ρ=0.312; README/BMAD status inconsistencies resolved (P2/P3 READMEs updated, 438_PfATP4 MD status corrected); DATA_ANALYSIS_REPORT_V2607 deleted)
...
| P3 — Hybrid Benchmark | 19,849 × 10 descriptors × 5CV (RF+SVM, QK per-fold) | **Launched on HPC (job 12617, depends on smoke job 12616); awaiting results** | 🚀 Launched |
...
8. **Classical benchmark (corrected):** ECFP4 AUC 0.949 on 19,849 molecules; PHCO bug fixed (0.500 → 0.897); full hybrid benchmark rerun launched on HPC (job 12617, depends on smoke job 12616) (P3)
...
| P3 Hybrid benchmark (10 descriptors) | 🚀 Launched (job 12617, depends on smoke job 12616) | Optimized script with rectangular QK chunking and --skip-ablation; awaiting results |
