...
**Generated:** July 9, 2026 — **Updated July 29, 2026** (v36: P4 v9 20-seed benchmark data consolidated and cross-verified against raw CSVs; component/fragment ablation and Pareto-front provenance documented; P3 classical-only 19,849 benchmark corrected (ECFP4 0.949; PHCO 0.897); 5000-molecule hybrid benchmark launched on HPC (job 12618, depends on smoke job 12616); expanded H₁-RRS n=77 ρ=0.312; README/BMAD status inconsistencies resolved (P2/P3 READMEs updated, 438_PfATP4 MD status corrected); DATA_ANALYSIS_REPORT_V2607 deleted)
...
| P3 — Hybrid Benchmark | 5,000 × 10 descriptors × 5CV (RF+SVM, QK per-fold) | **5000-molecule run on HPC (job 12618, depends on smoke job 12616); awaiting results** | 🚀 Launched (n=5000) |
...
| P3 Hybrid benchmark (10 descriptors) | 🚀 Launched (job 12618, n=5000, depends on smoke job 12616) | Optimized script with rectangular QK chunking and --skip-ablation; awaiting results |
