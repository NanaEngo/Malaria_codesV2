...
| 7 | **Scale test: Slater-only vs Jastrow DMC, nconfig=300** | Running on HPC (PID 327431) | Repeated `Some weights are larger than 2` warnings — weight explosion, consistent with collapse |
