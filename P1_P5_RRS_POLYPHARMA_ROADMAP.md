...
**Version:** 1.8 — 10 August 2026 (numerical audits + JCIM readiness + P2 Set-C MD pipeline; **R11 Table S5 ADMET completed** with real values from parent-library ADMET-AI screening; **R5 register lifted** INTERNAL_WORK_AUTHORIZED; remaining-steps section refined)
