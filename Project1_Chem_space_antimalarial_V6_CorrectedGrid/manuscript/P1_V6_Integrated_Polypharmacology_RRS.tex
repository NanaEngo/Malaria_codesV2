...
Reading the two layers together is more informative than either alone. PP-06 is the only candidate in the top quartile of within-target scores for all four proteins and is simultaneously classified A* on its PfCRT mutant panel (mean RRS \num{92.4}\%), and PP-11, top-quartile on three targets, is likewise A* (\num{82.6}\%), whereas PP-13 combines a Pareto-front position in the four-target profile with the second-highest mean RRS (\num{104.8}\%). These three candidates therefore represent the workflow's most economical combined multi-target and mutation-resilience hypotheses and its most defensible first choices for biochemical, mutant-panel, and molecular-dynamics follow-up. The other A* assignments are either PfCRT-only (PP-02, PP-06, PP-11, PP-13) or pair a moderate four-target profile with PfDHFR resilience (PP-01, PP-15); none of these operational assignments should be read as confirmed activity.
