#!/usr/bin/env python3
"""Generate the ACS-compliant Table of Contents graphic for P1 V6.
...
Outputs (in manuscript/Graphics/):
  - p1_v6_toc_graphic.pdf  (vector, canonical for the .tex)
  - p1_v6_toc_graphic_ACS.tiff  (300 dpi RGB, for the ACS submission portal)
"""
...
FIG_DIR = V6 / "manuscript" / "Graphics"
