...
# <repo>/Project4_.../scripts/p4_activity_rf_oracle.py -> parents[1] is the P4
# project directory and parents[2] the repository root. Either can be
# overridden with the P4_ROOT / MALARIA_REPO_ROOT environment variables.
P4_ROOT = Path(os.environ.get("P4_ROOT", Path(__file__).resolve().parents[1]))
REPO_ROOT = Path(os.environ.get("MALARIA_REPO_ROOT", P4_ROOT.parent))

P5_PANEL = REPO_ROOT / "Project5_GNN_Transformer_DrugDiscovery" / "results" / "p5_canonical_panel.csv"
P4_V12_DIR = P4_ROOT / "results" / "benchmark_molecules_opt_v12"
P4_MERGED = P4_V12_DIR / "p4_benchmark_merged.csv"
P4_PARETO = P4_ROOT / "results" / "pareto" / "merged_pareto_front.csv"
OUT_DIR = P4_ROOT / "results" / "pareto"
