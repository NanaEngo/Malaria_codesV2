...
| v4 | Aug 8, 2026 | **Réplication indépendante + validation externe MoleculeNet malaria** | random + scaffold | **Réplication ECFP4-RF (jobs 12844/12845)** : verdict **PASS** (écart 0.000 vs committé, tol. 0.005) — protocole ECFP4-RF (RDKit Morgan r=2, 2048bits, RF 500, splits figés) verrouillé (`p5_replication_verification.json`). **Validation externe MoleculeNet malaria n=22,072 (jobs 12846-12848, GPU)** : scaffold **ECFP4-RF 0.9192 > GIN 0.8843 (Δ=+0.0346, p<0.0001)** ; random 0.9547 vs 0.9237 (Δ=+0.031, p=0.0001). Le verdict « fingerprints > GNN » est reproduit sur un panel public indépendant → **L3 renforcé hors panel canonique**. **Manuscrit `P5_manuscript_V2608.pdf` compilé (08/08 06:58)** : 0 erreur/undefined/TODO, cover letter JoC. | `p5_replication_verification.json`, `p5_public_malaria_report.json`, `P5_manuscript_V2608.pdf` |
