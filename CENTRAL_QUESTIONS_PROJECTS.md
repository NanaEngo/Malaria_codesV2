...
3. TNE was valid for 19,836/19,849 molecules on the canonical panel, with 13 failures. On the external ChEMBL label-source-shift panel, 22,447 molecules were evaluated; 351 TNE embeddings failed (1.6%), leaving 22,096 complete cases. The intention-to-evaluate analysis retained the failures as zero-vector penalties, and the complete-case sensitivity analysis gave the same qualitative ranking. This external panel is distinct from the canonical panel and does not establish molecule-disjoint generalisation.
