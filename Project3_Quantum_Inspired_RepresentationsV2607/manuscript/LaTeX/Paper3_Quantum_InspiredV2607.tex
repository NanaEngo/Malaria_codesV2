...
The 20 high-confidence polypharmacological leads identified in our companion molecular dynamics validation study \citep{temgoua2027md} include both Class~A (resistance-resilient, active against drug-sensitive and resistant \textit{P.~falciparum} strains) and Class~D (resistance-vulnerable) compounds.
