...
\cref{tab:chembl_validation} reports the results of querying the ChEMBL database for experimental IC$_{50}$ data against the top-10 P3 candidates. For each candidate, the closest structural analogue with experimental activity data is identified by Tanimoto similarity.
...
\end{tabularx}
\vspace{1mm}
\footnotesize Only 1 of 10 top candidates had a structural analogue (Tanimoto $\geq 0.35$) with experimental ChEMBL data. The match was inactive (IC$_{50}$ $15.6$~\si{\micro\molar}), suggesting the generated candidates occupy chemical space with few close ChEMBL analogues --- a preliminary indication of structural novelty.
\end{table}
