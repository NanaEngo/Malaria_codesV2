...
\begin{table}[htbp]
\centering
\caption{Top-5 quantum circuit configurations from the grid search (60 combinations, 5-fold CV, $n = 200$ molecules). The default configuration ($d = 8$, $n_{\text{rep}} = 2$, $n_{\text{kpca}} = 20$) is highlighted.}
...
\midrule
6 & 1 & 30 & 0.8534 & 0.0490 \\
6 & 1 & 20 & 0.8487 & 0.0512 \\
6 & 2 & 30 & 0.8461 & 0.0503 \\
4 & 1 & 30 & 0.8412 & 0.0521 \\
8 & 2 & 20 & 0.8420 & 0.0510 \\
\bottomrule
\end{tabularx}
\vspace{1mm}
\footnotesize The default configuration (row 5) is used throughout the main manuscript for consistency with the full-library benchmark.
\end{table}
