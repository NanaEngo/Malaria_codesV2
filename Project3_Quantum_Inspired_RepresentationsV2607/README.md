...
| **Target Journal** | *Journal of Cheminformatics* |
| **Manuscript** | Main `Paper3_Quantum_InspiredV2608.tex` (18 p. / 7 230 mots) + SM (18 p.) + cover letter (1 p.) — trim 26→18 p. (02/08/2026), fusion des tables benchmark/hybrid, `tab:qkernel`→SM S13, titre harmonisé |
...
├── manuscript/LaTeX/
│   ├── Paper3_Quantum_InspiredV2608.tex        # Main manuscript (canonical, 18 p.)
│   ├── Paper3_Quantum_Inspired_SM_V2608.tex    # Supplementary Material (canonical, 18 p.)
