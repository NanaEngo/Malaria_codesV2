...
| **Manuscrit (V4)** | ✅ **Remédiation 2F6I COMPLÈTE (09-10/08)** | **484 = 458 PASS + 1 PENDING (171) + 15 exclusions boron (AD4) + 5 DOCKED_GATE_FAILED + 5 EMBED_FAILURE** — récapitulatif `results/pfclpp_2f6i_484_final_accounting.csv/.json` + dossier v2.0 prêt-à-signer `PFCLPP_2F6I_484_INDEPENDENT_REVIEW_DOSSIER.md` ; registre PENDING (réactivation à la demande de l'auteur) |
