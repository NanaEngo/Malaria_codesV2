...
> ⚠️ **Manuscrit P1 SOUMISSION = V7 (JCIM)** : `Project1_Chem_space_antimalarial_V7_CorrectedGrid/manuscript/P1_V7_Integrated_Polypharmacology_RRS.tex` (main 25 p.) + `_SM.tex` (13 p.) + cover letter ; **package ACS auto-contenu `submission_ACS_P1V7/`** (PDF + .bbl/.aux pour xr + .bib). **V7 supersedes V6 (11/01/2026)** with comprehensive enhancements: (1) **Validation documentation** — 3 tables (DEKOIS 2.0 external benchmark, MMV enrichment, redocking RMSD), SM Section S11 with 4 subsections, transparent reporting of capabilities & limitations; (2) **Physicochemical characterization** — 3 tables (properties, drug-likeness, ADMET profile); (3) **Enhanced narrative** — Results rewritten scientific style, Discussion expanded +125%, anti-AI patterns eliminated; (4) **Methodological rigor** — grid box specifications all targets, efficiency discussion (99.3% cost reduction). **V4/V5/V6 = archives pré-soumission** (V4 : espace chimique + overlay intégré, remédiation 2F6I 484 ; V5 : docking ciblé 68 paires, 4 ancres biologiques ; V6 : version 10/08/2026, 19 p. main/5 p. SM). **Compilation V7 : main 25 p., SM 13 p., 0 erreur / 0 réf. indéfinie** ✅. **V7 PRÊT pour Paragon Plus** — restent : ORCID ×5, funding, lecture auteur finale.
...
| **Manuscrit V7 (SOUMISSION JCIM - CANONICAL 11/01/2026)** | ✅ **Enhanced & Ready** | Main 25 p., SM 13 p., 0 erreur ; **comprehensive validation** (DEKOIS/MMV/redocking) + physicochemical tables + enhanced narrative ; supersedes V6 ; package `submission_ACS_P1V7/` prêt ; restent : ORCID ×5, funding |
| **Manuscrit V6 (archive 10/08/2026)** | ✅ **Archive** | Étude intégrée RRS + polypharmacologie (Set C 17, classes A*:6/B:5/C:5/D:1) ; revue croisée `FINAL_CROSS_REVIEW_P1_V456.md` : toutes valeurs conformes, prose publication, 0 erreur ; package `submission_ACS_P1V6/` auto-contenu |
