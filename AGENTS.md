...
### P1 — Chemical Space & Docking ✅ (V4 submission blocked pending full 2F6I/PfClpP revalidation; V5 raw evidence pending independent review)
...
| 12907 | `p5_gnn_metrics` | ⏳ **Pending resources** | Aucun résultat promu tant que le job n’est pas terminal et vérifié |
| 12908 | `p3_extval` | ⏳ **Pending priority** | Validation externe en attente de ressources/priorité |
| 12909 | `p4_pareto` | ⏳ **Pending priority** | Array 20 seeds; aucune sortie présente lors du snapshot |
