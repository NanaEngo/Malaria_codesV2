...
| **Manuscrit — Section Results/Benchmark** | ✅ **Actualisé** | **Benchmark v11 20 seeds** (optimal MCTS config, job 12725 — Random 0.7335 > MCTS 0.7276 > GA 0.7027 > Greedy 0.6147; Δ MCTS–Random = 0.006, t₁₉=2.41, p=0.026) ; v9 non-reproductible (oracle/library drift) puis v10 fixé (oracle 4700×) puis **v11 fixe le config MCTS (c_PUCT=5.0 + ScafVAE, auparavant défaut c_puct=1.414 sans policy)** ; SM S1–S3 (Pareto provenance, diversité réelle, reproductibilité) ; QMC retiré du manuscrit (cleanup 29/07 ; diagnostic Tier 2 non publication-grade) |
