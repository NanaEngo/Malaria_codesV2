...
This section describes a phenotype-only benchmark based on the public LISH mechanism-of-action (MoA) release. The benchmark is pharmacological rather than chemical: it tests how well gene-expression and viability readouts predict a drug's MoA. It does not address whether the molecular representations examined in the main analysis capture that pharmacology, because no structural information links the two data sets.
