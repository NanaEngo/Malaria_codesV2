...
**Final manuscript package (27 August 2026):** main text **16 pages** (`P5_manuscript_V2608.tex`), Supporting Information **2 pages** (`P5_SI_V2608.tex`, added 27 August), cover letter **1 page** (`Cover_Letter_P5_JCAMD.tex`). Zero LaTeX errors, zero undefined references, zero Overfull/Underfull warnings; `git diff --check` clean; Zenodo package rebuilt at **22/22 files** (`zenodo_package_20260827.tar.gz`). Target journal: **Journal of Computer-Aided Molecular Design (JCAMD, Springer Nature)**; guideline audit recorded in `docs/JCAMD_GUIDELINE_AUDIT_20260827.md`.
