...
\centering
\scriptsize
\caption{Evidence scope and next validation. The computational results support prioritization and structural hypotheses within the stated cohorts; they do not substitute for biochemical, biophysical, phenotypic, or clinical measurements.}
...
Set-C MD pilot & Secondary trajectory-derived comparison for PP-01 and PP-02; single replicate per system & Independent mutant/wild-type replicates with declared convergence and uncertainty analyses \\
