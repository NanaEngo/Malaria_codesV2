...
OUT_BASE="$BASE_PATH/Docking_6UKJ/results"
CONFIG="$BASE_PATH/Docking_6UKJ/config.txt"
CSV_FILE="$OUT_BASE/summary_results_6ukj.csv"
REPORT_FILE="$OUT_BASE/progress_report_6ukj.txt"
