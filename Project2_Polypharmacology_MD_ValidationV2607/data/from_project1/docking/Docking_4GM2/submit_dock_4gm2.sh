...
OUT_BASE="$BASE_PATH/Docking_4GM2/results"
CONFIG="$BASE_PATH/Docking_4GM2/config.txt"
CSV_FILE="$OUT_BASE/summary_results_4gm2.csv"
REPORT_FILE="$OUT_BASE/progress_report_4gm2.txt"
