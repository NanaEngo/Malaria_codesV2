...
OUT_BASE="$BASE_PATH/Docking_7F3Y/results"
CONFIG="$BASE_PATH/Docking_7F3Y/config.txt"
CSV_FILE="$OUT_BASE/summary_results_7f3y.csv"
REPORT_FILE="$OUT_BASE/progress_report_7f3y.txt"
