...
- **Relaunches (16 Sept):** job 15851 (`--array=2`, `PP-01_PfDHFR_C59R`) COMPLETE (2 ns, 201 frames, ligand max 0.475 nm — well-behaved, closes the task-2 truncation) and job 15852 (`--array=3`, `PP-01_PfDHFR_S108N`) COMPLETE (finished 16:52 UTC; 2 ns, 201 frames; T = 310.15 K, P = 4.64 bar, potential −4.337×10⁶ kJ/mol; backbone 0.166/0.185, ligand 0.247/0.470 nm, max 0.511 — well-behaved, closes the task-3 truncation); new versioned run dirs `short_<job>_<task>`, truncated runs kept untouched. Relaunch logs live under `/home/nanaengo/logs/` with WorkDir `/home/nanaengo` (not the project `logs/`) — noted for future audits.
- **Thermostat/barostat sanity (completed runs, `gmx energy` averages):** T = 310.14–310.19 K; P = −0.58–4.64 bar (task 12 I164L: T = 310.14 K, P = −0.47 bar, potential −4.336×10⁶; task 13 CRT WT: T = 310.15 K, P = 2.42 bar, potential −3.281×10⁶; task 14 K76T: T = 310.19 K, P = 1.46 bar, potential −3.280×10⁶; task 15 K76A: T = 310.17 K, P = −0.58 bar, potential −3.280×10⁶; relaunch task 2: T = 310.15 K, P = 0.88 bar, potential −4.338×10⁶ kJ/mol); near-zero 2 ns mean pressures are normal Parrinello-Rahman fluctuation around the 1 bar setpoint, not a leak; potentials stable within target family (DHFR ≈ −4.34×10⁶, CRT ≈ −3.28×10⁶ kJ/mol); conserved-energy drift negligible.
- **Backbone RMSD, fit = backbone, full 2 ns (mean / last-frame, nm):** PP-01 WT 0.172/0.211; N51I 0.154/0.173; I164L 0.186/0.200; CRT WT 0.181/0.215; K76T 0.171/0.197; K76A 0.210/0.238; PP-02 WT 0.158/0.192; PP-02 N51I 0.201/0.230; PP-02 C59R 0.145/0.174; PP-02 S108N 0.157/0.188; PP-02 I164L 0.161/0.180; PP-02 CRT WT 0.200/0.287; CRT K76T 0.150/0.187; CRT K76A 0.182/0.256; PP-01 C59R relaunch 0.172/0.190; PP-01 S108N relaunch 0.166/0.185 (n = 201 frames each; global min 0.0005, max 0.306 nm over all 16 completed runs / 3216 frames, recomputed 16 Sept). All < 0.25 nm — no unfolding. (S108N partial 0.137/0.151 nm on 0.4 ns recorded for completeness only, excluded from conclusions.)
- **Ligand RMSD after backbone fit (MOL0, 40 atoms; mean / last-frame, nm):** PP-01 WT 0.246/0.201; N51I 0.577/0.647; I164L 0.363/0.362; CRT WT 0.666/0.646; K76T 0.345/0.505; K76A 0.387/0.703; PP-02 WT 0.380/0.395; PP-02 N51I 0.293/0.217; PP-02 C59R 0.149/0.093; PP-02 S108N 0.268/0.359; PP-02 I164L 0.661/1.119; PP-02 CRT WT 0.167/0.131; CRT K76T 0.186/0.238; CRT K76A 0.279/0.328; PP-01 C59R relaunch 0.345/0.388; PP-01 S108N relaunch 0.247/0.470 (global min 0.0004, max 1.172 nm over all 16 completed runs / 3216 frames, recomputed 16 Sept — the max is task 12 PP-02 I164L at t ≈ 1.78 ns: first 0.5 nm crossing at t ≈ 0.84 ns, 61/201 frames above 1.0 nm, last-10 mean 1.104 nm, i.e. a sustained late excursion consistent with partial exit on this 2 ns exploratory run; the earlier task-5 transient, 1.129 nm at t ≈ 1.02 ns with return, stands). Elevated drift (N51I, CRT WT means > 0.5 nm; K76A last frame 0.703 nm) is an observation on 2 ns exploratory runs, NOT a binding, resistance, or pose-loss conclusion; no claim promoted.
- **PP-02 I164L excursion resolved — PBC/exit hypothesis REJECTED (16 Sept 2026):** `gmx mindist` (Protein vs MOL0, index group 21) on task-12 `short.xtc` AND on a `-pbc whole` reconstruction gives identical results over all 201 frames: mean 0.199, max 0.247 nm, last-10 mean 0.204 nm, ZERO frames > 0.5 nm. The ligand never leaves protein contact — no dissociation, no PBC-splitting artifact (raw == whole exactly). The >1 nm ligand-fit RMSD excursion is therefore an in-pocket reorientation relative to the start pose (rotation/slide maintaining contact), not an exit; the `consistent with partial exit` phrasing in the bullet above is SUPERSEDED. At 2 ns single-replicate scope this remains an observation only — whether the reorientation is a stable alternate pose or a transient requires longer sampling, explicitly out of scope under the 25 ns cap decision (no follow-up planned).
- **Artifacts (HPC, per completed run dir `runs/short_15840_<task>/`):** `rmsd_backbone.xvg`, `rmsd_ligand.xvg`, `rmsd_idx.ndx` (MOL0 = group 13, 56 atoms on PP-02 DHFR + CRT tprs verified 16 Sept; tasks 9–15 + both relaunches: xvg triplets incl. `energy.xvg`, no ndx — same numeric groups 4/13, default index; stray `index.ndx` files from group verification removed; task-12 follow-up adds `whole.xtc`, `mindist_raw/whole.xvg`, `ncont_raw/whole.xvg`, `i164l.ndx`).
