...
- **Completion (verified 16 Sept, `penavoraserver`, GROMACS 2025.4 CUDA):** tasks 0, 1, 4, 5, 6, 7, 8, 9, 10, 11 reached full 2 ns (`Finished mdrun`; 201 xtc frames × 10 ps; ~31–33 ns/day DHFR systems, ~43 ns/day CRT systems). Task 10 (`PP-02_PfDHFR_C59R`) finished 07:22 UTC and task 11 (`PP-02_PfDHFR_S108N`) finished 08:52 UTC (~32.5 / ~32.1 ns/day); tasks 12–15 queued (throttle `%1`); relaunches 15851/15852 still queued behind the array on the single GPU (`Priority`/`Resources`).
...
- **Relaunches (16 Sept):** job 15851 (`--array=2`, `PP-01_PfDHFR_C59R`) and job 15852 (`--array=3`, `PP-01_PfDHFR_S108N`); new versioned run dirs `short_<job>_<task>`, truncated runs kept untouched.
- **Thermostat/barostat sanity (completed runs, `gmx energy` averages):** T = 310.14–310.16 K; P = 1.07–3.65 bar (task 9 N51I: T = 310.15 K, P = 1.73 bar, potential −4.336×10⁶ kJ/mol; task 10 C59R: T = 310.16 K, P = 3.65 bar, potential −4.338×10⁶ kJ/mol; task 11 S108N: T = 310.15 K, P = 0.98 bar, potential −4.337×10⁶ kJ/mol); potentials stable within target family (DHFR ≈ −4.34×10⁶, CRT ≈ −3.28×10⁶ kJ/mol); conserved-energy drift negligible.
- **Backbone RMSD, fit = backbone, full 2 ns (mean / last-frame, nm):** PP-01 WT 0.172/0.211; N51I 0.154/0.173; I164L 0.186/0.200; CRT WT 0.181/0.215; K76T 0.171/0.197; K76A 0.210/0.238; PP-02 WT 0.158/0.192; PP-02 N51I 0.201/0.230; PP-02 C59R 0.145/0.174; PP-02 S108N 0.157/0.188 (n = 201 frames each; global min 0.0005, max 0.306 nm over the 10 completed runs, recomputed 16 Sept). All < 0.25 nm — no unfolding. (S108N partial 0.137/0.151 nm on 0.4 ns recorded for completeness only, excluded from conclusions.)
- **Ligand RMSD after backbone fit (MOL0, 40 atoms; mean / last-frame, nm):** PP-01 WT 0.246/0.201; N51I 0.577/0.647; I164L 0.363/0.362; CRT WT 0.666/0.646; K76T 0.345/0.505; K76A 0.387/0.703; PP-02 WT 0.380/0.395; PP-02 N51I 0.293/0.217; PP-02 C59R 0.149/0.093; PP-02 S108N 0.268/0.359 (global min 0.0004, max 1.129 nm over the 10 completed runs, recomputed 16 Sept — the earlier "max 0.530 nm" was wrong and is corrected here; the max is a transient mid-run excursion on task 5 PP-01 CRT WT at t ≈ 1.02 ns, last-10-frames mean 0.704 nm, i.e. return not exit). Elevated drift (N51I, CRT WT means > 0.5 nm; K76A last frame 0.703 nm) is an observation on 2 ns exploratory runs, NOT a binding, resistance, or pose-loss conclusion; no claim promoted.
- **Artifacts (HPC, per completed run dir `runs/short_15840_<task>/`):** `rmsd_backbone.xvg`, `rmsd_ligand.xvg`, `rmsd_idx.ndx` (MOL0 = group 13, 56 atoms on PP-02 tpr verified 16 Sept; tasks 9–11: xvg triplets incl. `energy.xvg`, no ndx — same numeric groups 4/13, default index; a stray `index.ndx` created on task 10 during group verification was removed).
