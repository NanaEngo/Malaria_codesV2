...
\node[md, below=of mmgbsa] (pilot) {Set-C MD pilot\\16 systems planned\\not included before complete QC};
...
\node[align=center, text width=35mm, font=\scriptsize, below=1mm of pilot] {MD-RRS remains\\\textbf{NOT COMPUTED} until complete PASS QC};
\end{tikzpicture}
\end{document}
