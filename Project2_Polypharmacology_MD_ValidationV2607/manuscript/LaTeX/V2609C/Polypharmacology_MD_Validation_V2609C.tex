...
\title{Docking--Molecular Dynamics Divergence as a Discovery Signal for African Antimalarial Natural Products}
...
A single-ligand feasibility probe (PP-15, outside the Set-C cohort) extended the OpenFF protocol to wild-type PfDHFR and PfCRT; both systems completed \qty{10}{ns} production trajectories with valid checkpoints, yielding MM-GBSA estimates of \qty{-29.52 \pm 0.33}{\kcalmol} (PfDHFR) and \qty{-27.79 \pm 0.49}{\kcalmol} (PfCRT); no RRS estimate is reported for this probe (\cref{SM-tab:s_pp15}).
