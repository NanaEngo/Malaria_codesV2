...
STRING threshold sensitivity (confidence cutoffs 400, 700, 900) showed PNS rank stability ($\rho$ \numrange{0.9632}{0.9975}; 400-vs-700 \num{0.9975}, 700-vs-900 \num{0.9681}, 400-vs-900 \num{0.9632}), indicating threshold choice does not alter ranking within this panel — distinct from the PfCRT-centrality imputation sensitivity (\cref{SM-tab:s7_pns_sensitivity}).
