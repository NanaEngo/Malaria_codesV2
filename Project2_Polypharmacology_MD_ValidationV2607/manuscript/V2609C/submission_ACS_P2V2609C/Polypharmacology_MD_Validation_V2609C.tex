...
\caption{\textbf{Atomic-Level Mechanism of Dynamic Pose Retention via Conserved Hotspot Anchors.} ProLIF interaction fingerprint occupancy (\% of \qty{10}{\ns} production trajectory, 100 snapshots/system) revealing the physical basis of Estimand Divergence. (A) \textit{Pf}CRT central cavity residue Tyr16 functions as an indispensable aromatic anchor, maintaining \qty{96}{--}\qty{100}{\percent} $\pi$--$\pi$ stacking and hydrophobic contact persistence across six mutant states, effectively insulating candidates \textbf{PP-01} and \textbf{PP-02} against charge-altering K76T/K76A mutations; (B) \textit{Pf}DHFR binding pocket hotspots (Asp54 salt-bridge anchor, Leu46, Met55, and Ile14) exhibit near-total contact persistence (\qty{89}{--}\qty{100}{\percent}) across five mutant states (WT, N51I, C59R, S108N, I164L), locking Class-A* leads into resilient binding orientations. Rendered using \texttt{SciencePlots} publication styling.}
