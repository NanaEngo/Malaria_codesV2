#!/usr/bin/env python3
"""
Comprehensive MDAnalysis-based trajectory analysis for 214_PfCRT
...
print("="*80)
print("COMPREHENSIVE MD ANALYSIS: 214_PfCRT (MDAnalysis)")
print("="*80)
...
plt.suptitle('214_PfCRT MD Trajectory: RMSD and Binding Stability', 
...
plt.suptitle('214_PfCRT: Protein Flexibility and Ligand Contacts',
...
plt.suptitle('214_PfCRT: Complete MD Trajectory Timeline',
...
with open(report_file, 'w') as f:
    f.write("="*80 + "\n")
    f.write("COMPREHENSIVE MD ANALYSIS REPORT: 214_PfCRT\n")
