...
def check_versions(str_filename,ffdoc_filename):
	...
	if (strver == 0) or (ffver == 0):
		print("\nWARNING: Could not detect CGenFF version in one or both files.")
		print("This may happen if the .str was generated by a recent CGenFF/CHARMM-GUI.")
		print("Continuing anyway -- verify manually that versions are compatible.\n")
...
if Version(nx.__version__) < Version("2.0"):
	...
	if Version(nx.__version__) > Version("2.3"):
