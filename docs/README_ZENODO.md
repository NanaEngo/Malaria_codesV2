...
**Updated:** 28 August 2026 20:10Z
**Status:** DOI reserved; upload pending. P5 V2 package 31/31 staged (READY_FOR_UPLOAD_NOT_UPLOADED). The repository does not claim that a Zenodo record is published.
...
|---|---|---|
| P1 | `BMAD_Q1_DATA_ANALYSIS_REPORT.md` and `Project1_Chem_space_antimalarial_V7_CorrectedGrid/` | V7 submission-ready package verified; deposit pending |
| P2 | `BMAD_Q1_DATA_ANALYSIS_REPORT.md` and `Project2_Polypharmacology_MD_ValidationV2607/` | Main 41p + SM 8p compiled; Set-C MD-RRS pilot complete; external docking 312/312 + RRS done; deposit pending |
...
| P5 V2 | `P5_DATA_ANALYSIS_REPORT.md` and `Project5_GNN_Transformer_DrugDiscovery_V2609/` | Main 16p + SI 5p + cover compiled; calibration + RRS/polypharma extensions; Zenodo package 31/31 staged `zenodo_package_20260827/`; upload pending |
