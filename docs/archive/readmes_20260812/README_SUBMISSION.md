...
| P5 | Journal of Cheminformatics (Springer) | main 12 p. / cover 1 p. — no SM | ✅ SUBMISSION-READY — external MoleculeNet validation + audit v2 + leak-audited benchmarks | `Project5_GNN_Transformer_DrugDiscovery/manuscript/SUBMISSION_MANIFEST.md` |

## Notes

- Manifests list canonical submission files with SHA-256 hashes for integrity verification.
- Zenodo deposit (P3) deferred by author; DOI reserved 10.5281/zenodo.19608875.
- P2 MD-RRS remains pending: isolated witness chain 15254→15259→15260 is active, while the full-panel MD-RRS is not yet computed.
- Regenerate any manifest with: python scripts/make_submission_manifests.py
