...
*   **État d'avancement (18 juillet 2026) :**
    ...
    - **Job 7943** (`p3_qi_5k`) : benchmark hybride 5 000 mols, 48 CPU, en cours d'exécution (~4h30 écoulées / 48h walltime). 8/9 descripteurs classiques terminés ; en cours : fold 1 noyau quantique (~55% des blocs QK complétés).
